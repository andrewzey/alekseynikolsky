      ...
      <Flex wrap justify="center">
        <Box col={12} sm={12} p={2} style={{position: 'relative'}}>
          ...
          <HeroOverlay type="research">
            ...
            <p>More recently my attention has gone into investigating the history of popular music, history of so-called “folk music,” and history of development of the music market. I sought to understand whether the state of music today is an aberration of biomusicological “norm” or an organic historic development that only seems to decline in its capacity to communicate information from creator of music to its listener.</p>
            <p>It was in 2013 that I decided to start publishing some of my findings and soliciting critical review. I believe that integration of many disciplines will reveal the formative role that music has played in the cognitive development of humanity.</p>
          </HeroOverlay>
        </Box>
